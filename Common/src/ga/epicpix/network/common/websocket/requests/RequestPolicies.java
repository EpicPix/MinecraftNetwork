...
public final class RequestPolicies {
    ...
    public static boolean isAllowed(int opcode, String clazz) {
        if((opcode==Opcodes.UPDATE_SERVER_DATA || opcode==Opcodes.REMOVE_SERVER || opcode==Opcodes.MAKE_WEB_SOCKET_SERVER_OWNER || opcode==Opcodes.SEND_SIGNAL) && clazz.equals(ServerInfo.class.getName())) {
            return true;
        }
